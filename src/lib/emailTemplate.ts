    ...
    ? `<td width="50%" style="padding:0 0 0 8px;vertical-align:top;">
                  <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:16px 18px;">
                    ...
                    <p style="margin:0;font-size:15px;color:#0f172a;font-weight:500;">
                      <a href="tel:${trimmedPhone}" style="color:#3B82F6;text-decoration:none;">${trimmedPhone}</a>
                    </p>
                  </div>
                </td>`
    : `<td width="50%" style="padding:0 0 0 8px;vertical-align:top;">
                  <div style="background:#f8fafc;border:1px solid #e2e8f0;border-radius:6px;padding:16px 18px;">
                    <p style="margin:0 0 4px;font-size:10px;color:#94a3b8;text-transform:uppercase;letter-spacing:0.12em;font-weight:600;">Telefon</p>
                    <p style="margin:0;font-size:15px;color:#64748b;font-weight:500;">Nicht angegeben</p>
                  </div>
                </td>`;
          ...
          <td style="background:#0A1628;padding:32px 40px;border-radius:8px 8px 0 0;">
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td align="right">
                  <span style="background:#22c55e;color:#ffffff;font-size:10px;font-weight:600;letter-spacing:0.15em;text-transform:uppercase;padding:4px 12px;border-radius:2px;">Bestätigung</span>
                </td>
              </tr>
            </table>
          </td>
